...
require_once '/usr/share/php/Defr/CzechDataBox/autoload.php';

spl_autoload_register(function (string $class): void {
    $prefix = 'AbraFlexiIsds\\';

    if (str_starts_with($class, $prefix)) {
        $file = '/usr/lib/abraflexi-isds/AbraFlexiIsds/'.str_replace('\\', '/', substr($class, \strlen($prefix))).'.php';
...
(function (): void {
    ...
    $version = '0.0.0';
    $versions[$name] = [
        'pretty_version' => $version, 'version' => $version,
        'reference' => null, 'type' => 'library', 'install_path' => __DIR__,
        'aliases' => [], 'dev_requirement' => false,
    ];
    \Composer\InstalledVersions::reload([
        'root' => [
            'name' => $name, 'pretty_version' => $version, 'version' => $version,
            'reference' => null, 'type' => 'library', 'install_path' => __DIR__,
            'aliases' => [], 'dev' => false,
        ],
        'versions' => $versions,
